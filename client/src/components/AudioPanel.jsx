    ...
    <div className="flex flex-col gap-2">
      <div className="flex items-center gap-2">
        <button
          ...
          className={[
            ...
            mute ? 'bg-red-600 text-white' : 'bg-slate-800 text-slate-400 hover:bg-slate-700',
          ].join(' ')}
        >
          {mute ? 'MUTED' : 'AUDIO'}
        </button>
        <div className="flex items-center gap-1 flex-1">
          <span className="text-[9px] text-slate-500 shrink-0">vol</span>
          <input
            type="range"
            min="0"
            max="2"
      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="flex items-center gap-1">
          <span className="text-[9px] text-slate-500 shrink-0">in</span>
          <input
            type="range"
            min="0"
            max="5"
        ...
        <div className="flex items-center gap-1">
          <span className="text-[9px] text-slate-500 shrink-0">out</span>
          <input
            type="range"
            min="0"
            max="5"
